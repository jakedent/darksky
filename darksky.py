...
def main():
    ...
    while True:
        ...
        if 'currently' not in curr_conditions:
            ...
            if 'apparentTemperature' in curr_conditions['currently'] and isFloat(
            ...
            if 'precipProbability' in curr_conditions['currently'] and isFloat(
                ...
                streamer.log(":umbrella: Precipitation Probabiity(%)",
            ...
            if 'daily' in curr_conditions:
                if 'data' in curr_conditions['daily']:
                    if 'moonPhase' in curr_conditions['daily']['data'][0]:
                        ...
                        streamer.log(":cloud: Weather Conditions",
                                     weather_status_icon(curr_conditions['currently']['icon'], moon_phase))
